...
/**
 * Cross-content section: "Find support" / "Need support?" Theme-derived
 * resource list that hides when there are no matches. Never fabricates.
 *
 * Uses the same compact card shape Phase C established so the look across
 * Story, Podcast, and (future) Research pages stays consistent.
 */
