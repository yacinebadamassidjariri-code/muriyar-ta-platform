  ...
  return (
    <label>
      ...
      <select
        ...
        onChange={onChange}
        disabled={pending}
        className="rounded-md border border-line bg-surface px-2 py-1.5 text-sm text-ink focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600"
      >
        {locales.map((l) => (
