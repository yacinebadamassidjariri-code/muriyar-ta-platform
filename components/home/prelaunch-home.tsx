...
export function PrelaunchHome({ locale }: { locale: Locale }) {
  ...
  return (
    <div
      id={motionRootId}
      className={cn(
        "relative left-1/2 -my-8 w-screen -translate-x-1/2 bg-[#F8F3EC]",
        styles.root,
      )}
    >
      <PrelaunchMotion rootId={motionRootId} />
      <span aria-hidden="true" className={styles.progressRule} />
      <div className="relative mx-auto max-w-6xl overflow-hidden px-4 pb-12 md:pb-20">
        <BotanicalCorner
          className={cn(
            "pointer-events-none absolute -right-3 top-16 hidden h-24 w-24 text-rose-200 md:block",
            styles.botanicalDrift,
          )}
        />
        ...
        <header className="grid items-center gap-8 pb-16 pt-10 md:grid-cols-[minmax(0,3fr)_minmax(16rem,2fr)] md:gap-14 md:pb-24 md:pt-16">
          <div>
            <p
              className={cn(sectionLabel, styles.heroEntrance, styles.heroEyebrow)}
            >
              {c.hero.eyebrow}
            </p>
            <h1
              className={cn(
                "mt-6 max-w-3xl font-display text-5xl font-medium leading-[1.03] text-plum-800 md:text-7xl",
                styles.heroEntrance,
                styles.heroTitle,
              )}
            >
            ...
            <p
              className={cn(
                "mt-7 max-w-2xl text-lg leading-relaxed text-charcoal-500 md:text-xl",
                styles.heroEntrance,
                styles.heroIntro,
              )}
            >
            ...
            <p
              className={cn(
                "mt-5 max-w-2xl text-base leading-relaxed text-charcoal-500 md:text-lg",
                styles.heroEntrance,
                styles.heroImpact,
              )}
            >
            ...
            >
              <Link
                href="/submit"
                className={cn(
                  "inline-flex min-h-11 items-center justify-center bg-plum-700 px-6 py-3 text-base font-semibold text-cream-50 hover:bg-plum-800 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-plum-600",
            ...
            <p
              className={cn(
                "mt-8 max-w-2xl border-l border-rose-300 pl-5 text-sm leading-relaxed text-charcoal-500",
                styles.heroEntrance,
                styles.heroNote,
              )}
            >
          ...
          <div className={styles.heroLogoEntrance}>
            <div className={styles.logoDrift}>
              <Image
        ...
        <section
          data-motion-section
          aria-labelledby="prelaunch-stories"
        ...
        >
          ...
          <blockquote
            className={cn(
              "mx-auto my-14 max-w-4xl text-center font-display text-3xl font-medium leading-tight text-plum-800 md:my-20 md:text-5xl",
              styles.pullQuote,
            )}
          >
            “{c.stories.pullQuote}”
        ...
        >
          <div className="grid gap-10 md:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] md:gap-16">
            <div>
              <p data-motion-part="eyebrow" className={sectionLabel}>
                {c.storyTypes.eyebrow}
              </p>
              <h2
                data-motion-part="heading"
                id="prelaunch-story-types"
                className={sectionTitle}
              >
                {c.storyTypes.title}
              </h2>
              <p
                data-motion-part="body"
                className="mt-5 text-lg leading-relaxed text-charcoal-500"
              >
                {c.storyTypes.intro}
              </p>
            </div>
            <div>
              ...
              <p
                ...
                className="mt-6 font-medium leading-relaxed text-plum-800"
              >
        ...
        >
          ...
          <div
            data-motion-part="body"
            className="space-y-5 border-l-2 border-rose-300 pl-6 text-lg leading-relaxed text-charcoal-500 md:pl-8"
          >
        ...
        >
          <p data-motion-part="eyebrow" className={sectionLabel}>
            {c.protection.eyebrow}
          </p>
          <h2
            data-motion-part="heading"
            id="prelaunch-protection"
            className={sectionTitle}
          >
            {c.protection.title}
          </h2>
        ...
        >
          <div className="grid gap-10 md:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] md:gap-16">
            <div>
              ...
              <div
                data-motion-part="body"
                className="mt-5 space-y-4 text-lg leading-relaxed text-charcoal-500"
              >
            ...
            <aside
              data-motion-part="supporting"
              className="self-end border-l-2 border-rose-300 pl-6"
            >
              <p className="leading-relaxed text-charcoal-500">{c.support.limitation}</p>
              <Link
                href="/resources/crisis"
                className={cn(
                  "mt-5 inline-flex items-center gap-2 text-sm font-semibold text-plum-700 underline decoration-rose-300 underline-offset-4 hover:text-plum-900 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-plum-600",
                  styles.interactiveLink,
                )}
              >
        ...
        >
          <div data-motion-part="eyebrow">
            <div className={styles.symbolDrift}>
              <Image
          ...
          <div>
            ...
            <div
              data-motion-part="body"
              className="mt-7 max-w-3xl space-y-5 text-lg leading-relaxed text-charcoal-500"
            >
        ...
        >
          ...
          <dl
            data-motion-part="body"
            className="mt-8 grid gap-7 md:grid-cols-3 md:gap-12"
          >
            <div>
            ...
            <div>
              ...
              <dd className="mt-2">
                <a
                  ...
                  className={cn(
                    "inline-block break-all font-medium text-plum-700 underline decoration-rose-300 underline-offset-4 hover:text-plum-900 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-plum-600",
                    styles.interactiveLink,
                  )}
                >
                  {c.contact.email}
        ...
        <section
          ...
          className={cn(
            "mt-16 bg-plum-800 px-6 py-14 text-cream-50 md:mt-24 md:px-10 md:py-20",
            styles.destinationPanel,
          )}
        >
          <p
            data-motion-part="eyebrow"
            className="text-xs font-semibold uppercase tracking-[0.18em] text-rose-200"
          >
          ...
          <p
            data-motion-part="body"
            className="mt-5 max-w-2xl text-lg leading-relaxed text-stone-200"
          >
            {c.invitation.body}
          </p>
          <div
          ...
          >
            <Link
              href="/submit"
              className={cn(
                "inline-flex min-h-11 items-center justify-center border border-cream-50/60 px-6 py-3 text-sm font-semibold text-cream-50 hover:border-cream-50 hover:bg-cream-50 hover:text-plum-800 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-rose-200",
                styles.interactiveLink,
                styles.arrowCta,
              )}
            >
              ...
              <ArrowRight
                className={cn("ml-2 h-4 w-4", styles.ctaArrow)}
                aria-hidden="true"
              />
            </Link>
            <a
              ...
              className={cn(
                "inline-flex min-h-11 items-center px-2 text-sm font-semibold text-cream-50 underline decoration-rose-200/70 underline-offset-4 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-rose-200",
                styles.interactiveLink,
              )}
            >
