...
def generate_sql(result: dict, source_name: str) -> str:
    ...
    lines = [
        ...
        "-- Kept as one statement so Supabase CLI seed batching cannot commit and drop",
        "-- the temporary source table before validation completes.",
        "do $resource_seed$", "declare", "  mismatch_count integer;", "begin", "",
    ]
